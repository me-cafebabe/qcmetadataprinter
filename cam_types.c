...
/* cam_types.h */
    ...
    //PRINT(CAM_INTF_PARM_SCALE,pMetadata);
    ...
    //PRINT(CAM_INTF_PARM_GET_CHROMATIX,pMetadata);
    //PRINT(CAM_INTF_PARM_SET_RELOAD_CHROMATIX,pMetadata);
    PRINT(CAM_INTF_PARM_SET_AUTOFOCUSTUNING,pMetadata); 
    //PRINT(CAM_INTF_PARM_GET_AFTUNE,pMetadata);
    //PRINT(CAM_INTF_PARM_SET_RELOAD_AFTUNE,pMetadata);
    ...
    //PRINT(CAM_INTF_PARM_DO_REPROCESS,pMetadata);
    //PRINT(CAM_INTF_PARM_SET_BUNDLE,pMetadata);
    //PRINT(CAM_INTF_PARM_STREAM_FLIP,pMetadata);
    //PRINT(CAM_INTF_PARM_GET_OUTPUT_CROP,pMetadata);
    ...
    //PRINT(CAM_INTF_PARM_GET_IMG_PROP,pMetadata); 
    ...
    //PRINT(CAM_INTF_PARM_DCRF,pMetadata);
    ...
    //PRINT(CAM_INTF_PARM_REQUEST_FRAMES,pMetadata);
    //PRINT(CAM_INTF_PARM_REQUEST_OPS_MODE,pMetadata);
